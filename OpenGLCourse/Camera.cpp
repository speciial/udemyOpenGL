...
{
	// NOTE(christian): moving on a diagonal is faster!
...
void Camera::mouseControll(GLfloat xChange, GLfloat yChange)
{
	xChange *= turnSpeed;
	yChange *= turnSpeed;
...
void Camera::update()
{
	...
	// worldUP is not initialized;
	// shouldn't glm::lookAt do all this?
